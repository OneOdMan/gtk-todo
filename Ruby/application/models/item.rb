...
module ToDo
  class Item
    PROPERTIES = [:id, :title, :notes, :priority, :filename]
    # id: id of the item. specifies the group of the item
    # title: title of the item
    # notes: description of the item
    # priority: level of priority
    # filename: group that the item is a part of
    PRIORITIES = ['important', 'urgent', 'to-do']
